...
icon: https://github.com/Sammy970/decode-bms/blob/main/public/BookMyShow_ICON.png?raw=true,
---
...
<details>
  ...
  <ul className="list-disc">
    <li>
      <a href="#what-is-server-driven-ui">What is Server-Driven UI?</a>
    </li>
    <li>
      <a href="#why-use-server-driven-ui">Why Use Server-Driven UI?</a>
    </li>
    <li>
      <a href="#results">Results</a>
    </li>
    <li>
      <a href="#bookmyshow-web-and-mobile-vs-my-recreation-server-driven-ui">
        BookMyShow vs My Recreation
      </a>
    </li>
    <li>
      <a href="#how-i-built-a-server-driven-ui-framework-decode-bookmyshow">
      ...
      <ul>
        ...
        <li>
          <a href="#widget-types-implementation">Widget Types Implementation</a>
          <ul>
            <li>
              <a href="#1-cards">1. Cards</a>
            </li>
            <li>
              <a href="#2-flexbox">2. Flexbox</a>
            </li>
            <li>
              <a href="#3-horizontal-scroll">3. Horizontal Scroll</a>
            </li>
            <li>
              <a href="#4-carousel">4. Carousel</a>
            </li>
            <li>
              <a href="#5-advertisement">5. Advertisement</a>
            </li>
            <li>
              <a href="#6-mobile-bottom-navigation">
        ...
        <li>
          <a href="#style-management">Style Management</a>
        </li>
      </ul>
    </li>
    <li>
      <a href="#challenges-and-learnings">Challenges and Learnings</a>
    </li>
    <li>
...
<h2 id="what-is-server-driven-ui">What is Server-Driven UI?</h2>
...
<h2 id="why-use-server-driven-ui">Why Use Server-Driven UI?</h2>

Server-Driven UI offers several compelling advantages:

<h3 id="1-consistent-cross-platform-experience">
...
<h3 id="2-rapid-iterations-without-app-updates">
...
<h3 id="3-dynamic-content-presentation">3. Dynamic Content Presentation</h3>
...
<h3 id="4-reduced-client-complexity">4. Reduced Client Complexity</h3>
...
<h3 id="5-better-resource-management">5. Better Resource Management</h3>
...
<h2 id="how-i-built-a-server-driven-ui-framework-decode-bookmyshow">
  How I Built a Server-Driven UI Framework
</h2>
...
<h3 id="widget-types-implementation">Widget Types Implementation</h3>

<h3 id="1-cards">1. Card</h3>
...
<h3 id="3-horizontal-scroll">3. Horizontal Scroll</h3>
...
<h3 id="4-carousel">4. Carousel</h3>
...
<h3 id="5-advertisement">5. Advertisement</h3>
...
<h3 id="6-mobile-bottom-navigation">6. Mobile Bottom Navigation</h3>
...
<h2 id="style-management">Style Management</h2>
...
<h3 id="component-hierarchy-and-nesting">1. Component Hierarchy and Nesting</h3>
...
<h3 id="style-interpretation">2. Style Interpretation</h3>
...
<h3 id="error-handling-and-fallbacks">3. Error Handling and Fallbacks</h3>
